<?php
    ...
    $sql = "REPLACE tassessment_count SET coursesID=$coursesID,teachersID=$teachersID,status=1,userEmail='$email'";
    $resultcheck = mysqli_query($con,$sql);

    if ($resultcheck) {
        $sql= "REPLACE tassessment SET coursesID=$coursesID,teachersID=$teachersID,timestamp=(NOW());";
