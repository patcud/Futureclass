        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-11 col-xs-11 col-md-10 bg-light" style="margin-top: 20px;">
                <div class="container-fluid">
                    ...
                    <form action = "material_submit.php?id=<?php echo $coursesID; ?>" method="POST">
                        <div class="mb-3">
                            <label for="subjectidinput" class="form-label">Chapter</label>
                            <div class="decinput">
                            <input type="number" class="form-control" name="chapter" placeholder="พิมพ์เฉพาะเลขบท" required></div>
                        </div>
                        <div class="mb-3">
                            <label for="thainameinput" class="form-label">เนื้อหา</label>
                            <div class="decinput">
                            <input type="text" class="form-control" name="content" placeholder="รายละเอียดบท ภาพรวมของบท" required></div>
                        </div>
