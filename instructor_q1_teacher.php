<?php
    ...
    $sql2 = "SELECT * FROM teachers_good WHERE coursesID=$coursesID AND teachersID='$id' AND qtype = 'good' AND status=0 ORDER BY likeCount DESC";
        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-11 col-xs-11 col-md-10 bg-light" style="margin-top: 20px;">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="instructor_q1_teacher.php?id=<?php echo $coursesID; ?>">ข้อดี</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php 
                        while($a = mysqli_fetch_array($r)) {
                            ...
                            if ($report_color == '#979797') {
                                ...
                                <!-- ใส่ php -->
                                <a href="qt_report.php?id='.$qid.'&cid='.$coursesID.'&qn=q1" class="btn btn-danger" role="button">Report</a>
                                </div>
                                </div>
                                </div>
                                </div>'
