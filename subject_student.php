        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-6 col-xs-6 col-md-5 bg-light" style="margin-top: 15px; ">
                                    ...
                                    <!--ดึงไฟล์JSมาใช้-->
                                        ...
                                        <?php 
                                            ...
                                            $section = mysqli_fetch_array(
                                                mysqli_query($con,
                                                    "SELECT section FROM student_course WHERE studentsID = $id"
                                                )
                                            )[0];
                                        ?>
                ...
                <!-- Coppy ถึงตรงนี้พอคั้บ--> 
                    ...
                    <!-- Card Review สมมติยังไม่่ต้องดึงข้อมูล
                    <div class="col">
                        <div class="card" style="border-radius: 20px;">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Prerequisite</h5>
                                <h5 class="card-title text-danger">MATLAB</h5>
                            </div>
                        </div>
                    </div> -->
                        ...
                        <div class="card" style="border-radius: 20px;">
                            <div class="card-body">
                                ...
                                <dl class="row" id="aj_in_sub">
                                    <?php
                                        $sql = "SELECT teachersID FROM teacher_course WHERE coursesID=$coursesID ORDER BY section ASC";
                                        ...
                                        while($a = mysqli_fetch_array($r)) {
                                            ...
                                            echo '
                                                ...
                                                <dd class="col-sm-5" style="margin-bottom:0px"> section '.$rsub['section'].'</dd>
                                                </div>
                                                ';
                                        }
                                    ?>
