    ...
    <div class="container-fluid h-100 bg-light">
        ...
        <div class="row justify-content-md-center" style="margin-top: 4rem !important;">
            ...
            <div class="row">
                ...
                <div class="list-of-re" style="margin-top: 35px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="report_teacher_assessment.php">Teacher Assessment Report</a>
                        </li>
                    </ul>
                </div>
                <div class="row my-2">
                    <h3 style="margin-bottom:0px"> ความคิดเห็นต่อผู้สอนที่ถูกรายงานว่าไม่เหมาะสม </h3>
            ...
            <div id='requestment_report' class="row row-cols-1 g-3 bg-light"></div>
                <?php
                    $sql2 = "SELECT * FROM teachers_good_report WHERE report=1 AND action=0 ORDER BY timestamp DESC";
                    $r = mysqli_query($con, $sql2); 
                    while($a = mysqli_fetch_array($r)) {
                        $ra = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM teachers_good WHERE ID=$a[ID]"));
                        echo '
                            <div class="col">
                            ...
                            <div class="modal-footer">
                                ...
                                <!-- ใส่ไฟล์รันPHPต่อ -->
                                <a href="tassessment_delete.php?id='.$ra['ID'].'" type="button" class="btn btn-danger" formaction=".php">Delete</a>
                            </div>
                            </div>
                            </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                <!-- ใส่ไฟล์รันPHPต่อ -->
                                <a href="tassessment_pass.php?id='.$ra['ID'].'" type="button" class="btn btn-danger">Pass</a>
                            </div>
                            </div>
                            </div>
                            </div>
