<?php
    ...
    $sql2 = "SELECT * FROM courses_good WHERE coursesID=$coursesID AND qtype='problem' AND status=0 ORDER BY timestamp DESC";
        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-11 col-xs-11 col-md-10" style="margin-top: 20px;">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link text-danger" aria-current="page" href="assessment_subject_student.php?id=<?php echo $coursesID; ?>">คะแนน</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-danger" href="subject_q1.php?id=<?php echo $coursesID; ?>">ข้อดี</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="subject_q2.php?id=<?php echo $coursesID; ?>">ปัญหาที่พบ</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card" style="border-radius: 20px;background-color:transparent;border-color:transparent;">
                        <div class="row">
                            <div class="col-sm-11 col-9">
                                <h3>ปัญหาที่พบในการเรียนการสอนในรายวิชานี้</h3>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- form id="addcomment" -->
                                <form id="assessment1" method="POST" action="subject_q2_submit.php?id=<?php echo $coursesID;?>">
                                    <!--ตัวรับ Comment-->
                                    <div class="mb-3">
                                        <!--เก็บ Comment-->
                ...
                <div id='requestment_card' class="row row-cols-1 g-1 bg-light"></div>
                    <?php 
                        while($a = mysqli_fetch_array($r)) {
                            ...
                            $oldres = mysqli_fetch_array(mysqli_query($con,"SELECT response FROM courses_good_response WHERE qid=$qid and userEmail = '$email'"));
                            $like_color = '#979797';
                            ...
                            $report_color = '#979797';
                            $oldreport = mysqli_fetch_array(mysqli_query($con,"SELECT report FROM courses_good_report WHERE ID=$qid and userEmail = '$email'"));
                            if (isset($oldreport)) {
                                $report_color = '#ffc74d';
                            }
                            echo '
                                ...
                                <div class="col-sm-7">
                                <div class="box">
                                <form class="form" id="likedislikeform" method="POST" action="subject_q2_response.php?cid='.$coursesID.'&id='.$qid.'">
                            ...
                            if ($report_color == '#979797') {
                                ...
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <!-- ใส่ php -->
                                <a href="q_report.php?id='.$qid.'&cid='.$coursesID.'&qn=q2" class="btn btn-danger" role="button">Report</a>
                                </div>
                                </div>
                                </div>
                                </div>';
