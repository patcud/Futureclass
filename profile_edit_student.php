<?php
    ...
    $id = $_SESSION['userid'];
    $sql = "SELECT coursesID FROM student_course WHERE studentsID = $id ORDER BY coursesID ASC";
            ...
            <div class="card mb-12 mx-3" style="margin-top: 50px; border-style: hidden; background-color: transparent">
                <div class="row g-0 w-100">
                    ...
                    <div class="col-12 col-md-3" style="display: flex; align-items: center; justify-content: center;">
                        <!-- รูปโปรไฟล์ -->
                        <form action="profile_submit_student.php" method="POST" enctype="multipart/form-data">
