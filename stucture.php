<?php
    ...
    $id = $_SESSION['userid'];
    $r = mysqli_query($con,"SELECT coursesID FROM courses WHERE semesterID = 1 ORDER BY subjectsID ASC");
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="schedule.php">
                        ...
                        <br>
                        <label for="starttime" style="margin-right: 10px;">เวลาเริ่มการประเมิน</label>
