    ...
    <div class="container-fluid h-100 bg-light" style="padding-top: 6rem;">
        ...
        <?php
            ...
            $sql = "SELECT * 
                    ...
                    WHERE teachersID='$id'";
            $teacher = mysqli_fetch_assoc(mysqli_query($con,$sql));
            $abbr = $teacher['abbreviation'];
            $name = $teacher['fname'];
            $surname = $teacher['lname'];
            $email = $teacher['userEmail'];
        ?>
        <div class="container text-center" style="margin-top : 2rem !important;">
            <div class="mb-4">
                <h2>Teacher: <?= $name ?> <?= $surname?></h2>
            </div>
            <form action="./controller/admin/editTeacherInfo.php?id=<?= $id ?>" method="POST">
                <div class="container-fluid w-50">        
                    <div class="mb-3">
                        <label for="abbr" class="form-label fs-4">Abbreviation</label>
                        <div class="decinput"><input type="text" class="form-control" placeholder="<?= $abbr ?>" name="abbr"></div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2 col-6 mx-auto" style="margin-bottom: 20px;">
                        <button type="submit" class="btn btn-danger col-6">Save</button>
                        <a class="btn btn-danger col-6" href="home_admin_teacher.php"> Cancel</a>
                    </div>
                </div>
            </form>
