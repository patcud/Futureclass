<?php
    ...
    $sql2 = "SELECT * FROM courses_good WHERE coursesID=$coursesID AND qtype='good' AND status=0 ORDER BY timestamp DESC";
        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-11 col-xs-11 col-md-10" style="margin-top: 20px;">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="subject_q1.php?id=<?php echo $coursesID; ?>">ข้อดี</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- form id="addcomment" -->
                                <form id="assessment1" method="POST" action="subject_q1_submit.php?id=<?php echo $coursesID;?>">
                                    <!--ตัวรับ Comment-->
                                    <div class="mb-3">
                                        <!--เก็บ Comment-->
                    ...
                    <?php 
                        while($a = mysqli_fetch_array($r)) {
                            ...
                            echo '
                                ...
                                <div class="col-sm-7">
                                <div class="box">
                                <form class="form" id="likedislikeform" method="POST" action="subject_q1_response.php?cid='.$coursesID.'&id='.$qid.'">
