        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-11 col-xs-11 col-md-10 bg-light" style="margin-top: 20px;">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="instructor_q1_admin.php?id=<?php echo $coursesID; ?>&tid=<?php echo $_GET['tid'] ?>">ข้อดี</a>
                    </li>
                    <li class="nav-item">
                ...
                <div id='requestment_card' class="row row-cols-1 g-1 bg-light"></div>
                    <?php 
                        $sql2 = "SELECT * FROM teachers_good WHERE coursesID=$coursesID AND teachersID = $teachersID AND qtype='good' AND status=0 ORDER BY likeCount DESC";
                        ...
                        while($a = mysqli_fetch_array($rr)) {
                            ...
                            <div class="modal-footer">
                                ...
                                <!-- ใส่ไฟล์รันPHPต่อ -->
                                <a href="tassessment_delete.php?id='.$a['ID'].'" type="button" class="btn btn-danger" formaction=".php">Delete</a>
                            </div>
                            </div>
                            </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                <!-- ใส่ไฟล์รันPHPต่อ -->
                                <a href="tassessment_pass.php?id='.$a['ID'].'" type="button" class="btn btn-danger">Pass</a>
                            </div>
                            </div>
                            </div>
                            </div>
