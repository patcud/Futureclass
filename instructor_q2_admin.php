<?php
    ...
    $sql2 = "SELECT * FROM teachers_good WHERE coursesID=$coursesID AND teachersID = '$teachersID' AND qtype = 'suggestion' AND status=0 ORDER BY timestamp DESC";
        ...
        <div class="row flex-nowrap w-100" style="margin-top: 5rem !important;">
            ...
            <div class="col-11 col-xs-11 col-md-10 bg-light" style="margin-top: 20px;">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                            <a class="nav-link text-danger" aria-current="page" href="assessment_instructor_individual.php?id=<?php echo $coursesID; ?>&tid=<?php echo $_GET['tid'] ?>">คะแนน</a>
                        </li>
                    <li class="nav-item">
                        <a class="nav-link text-danger" href="instructor_q1_admin.php?id=<?php echo $coursesID; ?>&tid=<?php echo $_GET['tid'] ?>">ข้อดี</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="instructor_q2_admin.php?id=<?php echo $coursesID; ?>&tid=<?php echo $_GET['tid'] ?>">ข้อเสนอแนะ</a>
                    </li>
                </ul>
                <div class="mt-2">
                ...
                <div id='requestment_card' class="row row-cols-1 g-1 bg-light"></div>
                    <?php 
                        $sql2 = "SELECT * FROM teachers_good WHERE coursesID=$coursesID AND teachersID = $teachersID AND qtype='suggestion' ORDER BY likeCount DESC";
